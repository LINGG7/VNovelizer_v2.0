...
public class VNProjectConfigEditor : Editor
{
    ...
    public override VisualElement CreateInspectorGUI()
    {
        ...
        uiFoldout.Add(new PropertyField(serializedObject.FindProperty("UI_EndingChoicePath"), "结局选择面板"));
        ...
        galleryFoldout.Add(new PropertyField(serializedObject.FindProperty("Ending_DataPath"), "结局数据容器路径"));
