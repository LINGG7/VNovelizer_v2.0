...
public class GlobalDataManager : BaseManager<GlobalDataManager>
{
    ...
    private static bool CanApplyDisplaySettings
    {
        get
        {
#if UNITY_WEBGL
    ...
    {
        if (globalData != null && CanApplyDisplaySettings)
        {
    ...
    private void LoadGlobalData()
    {
        ...
        string json;
        if (TapMiniGamePersistentStorage.TryReadText(GLOBAL_DATA_PATH, out json) || File.Exists(path))
        {
        ...
        if (globalData.UnlockedEndings == null)
        {
            globalData.UnlockedEndings = new List<string>();
        }
    ...
    private void SaveGlobalData()
    {
        ...
        TapMiniGamePersistentStorage.WriteText(GLOBAL_DATA_PATH, json);
    ...
    public void UnlockEnding(string endingID)
    {
        ...
        if (!globalData.UnlockedEndings.Contains(endingID))
        {
            ...
            SaveGlobalData();
            EventCenter.GetInstance().EventTrigger("EndingUnlocked", endingID);
        }
    }
