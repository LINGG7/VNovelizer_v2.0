...
namespace VNovelizer.Core.API
{
    ...
    public static class VNAPI
    {
        ...
        /// <summary>
        /// Apply cover-style aspect fitting to a gameplay background image.
        /// </summary>
        public static void FitBackgroundImageToCover(Image image)
        {
            var panel = GetPanel();
            panel?.FitBackgroundImageToCover(image);
        }
