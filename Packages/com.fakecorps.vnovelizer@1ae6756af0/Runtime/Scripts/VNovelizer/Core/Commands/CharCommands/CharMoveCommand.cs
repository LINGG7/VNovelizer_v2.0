...
namespace VNovelizer.Core.Commands
{
    ...
    public class CharMoveCommand : VNCommand
    {
        ...
        public override IEnumerator ExecuteAsync(string args)
        {
            ...
            VNDebug.LogVerbose($"[TypingTrace][CharMove.ExecuteAsync] start args={args}");
            ...
            VNDebug.LogVerbose($"[TypingTrace][CharMove.ExecuteAsync] posCode={posCode}, startPos={startPos}, targetPos={targetPos}, duration={duration}");
            ...
            VNDebug.LogVerbose($"[TypingTrace][CharMove.ExecuteAsync] tween completed posCode={posCode}");
        ...
        {
            VNDebug.LogVerbose($"[TypingTrace][CharMove.Interrupt] tweenAlive={_moveTween.isAlive}, targetExists={_targetRect != null}");
            // 检查 Tween 是否还在运行
