...
namespace VNovelizer.Core.Commands
{
    ...
    public class CharFlipCommand : VNCommand
    {
        ...
        public override bool Execute(string args)
        {
            ...
            VNDebug.LogVerbose($"[TypingTrace][CharFlip.Execute] start args={args}");
            ...
            VNDebug.LogVerbose($"[TypingTrace][CharFlip.Execute] finish posCode={posCode}, targetScaleX={targetScaleX}");
