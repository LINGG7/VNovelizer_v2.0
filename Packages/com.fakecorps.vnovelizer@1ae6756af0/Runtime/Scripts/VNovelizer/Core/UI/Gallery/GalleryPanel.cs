...
public class GalleryPanel : BasePanel
{
    ...
    [SerializeField] private Color selectedTabTextColor = new Color(0.95f, 0.75f, 0.45f, 1f);
    [SerializeField] private Color normalTabTextColor = new Color(0.62f, 0.6f, 0.56f, 1f);
    ...
    // 状态
    public enum GalleryPage { CG, Scene, Ending, Music }
    private GalleryPage currentPage = GalleryPage.Scene;
    private bool openedFromMainMenu;
    private bool isClosing;

    public void SetOpenedFromMainMenu(bool value)
    {
        openedFromMainMenu = value;
    }
    ...
    private void SwitchPageInternal(GalleryPage page)
    {
        ...
        if (endingPage != null) endingPage.Hide();
    ...
    protected override void Awake()
    {
        ...
        endingButton = GetControl<Button>("EndingBtn");
        ...
        if (pageContainer != null)
        {
            ...
            GameObject endingPageObj = pageContainer.transform.Find("EndingPage")?.gameObject;
            if (endingPageObj != null)
            {
                endingPage = endingPageObj.GetComponent<EndingPage>();
                if (endingPage == null)
                {
                    endingPage = endingPageObj.AddComponent<EndingPage>();
                }
            }
        ...
        if (endingButton != null) endingButton.onClick.AddListener(() => SwitchPageInternal(GalleryPage.Ending));
    ...
    {
        SetTabSelected(cgButton, currentPage == GalleryPage.CG);
        SetTabSelected(sceneButton, currentPage == GalleryPage.Scene);
        SetTabSelected(endingButton, currentPage == GalleryPage.Ending);
        SetTabSelected(musicButton, currentPage == GalleryPage.Music);
    ...
    private void SetTabSelected(Button button, bool selected)
    {
        ...
        if (background != null)
        {
            ...
            colors.highlightedColor = new Color(0.95f, 0.75f, 0.45f, 0.08f);
            colors.pressedColor = new Color(0.95f, 0.75f, 0.45f, 0.14f);
            colors.selectedColor = clearColor;
        ...
        Transform selectedFrame = button.transform.Find("SelectedFrame");
    ...
    private void RequestClose()
    {
        ...
        bool started = UIManager.GetInstance().HidePanelWithDarkFade("GalleryPanel");
        if (!started)
        {
            isClosing = false;
        }
