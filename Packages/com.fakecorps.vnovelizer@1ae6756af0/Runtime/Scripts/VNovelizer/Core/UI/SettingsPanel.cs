...
public class SettingsPanel : BasePanel
{
    ...
    [SerializeField] private Color selectedTabBackgroundColor = new Color(0.22f, 0.15f, 0.1f, 0.95f);
    [SerializeField] private Color normalTabBackgroundColor = new Color(0.03f, 0.05f, 0.08f, 0.8f);
    ...
    {
        const string blockerName = "InputBlocker";
        ...
        ConfigureInputBlockerButton(blockerButton);
    }

    private void ConfigureInputBlockerButton(Button blockerButton)
    {
        if (blockerButton == null) return;
    ...
    {
        SetTabSelected(volumePageBtn, currentPageIndex == 0);
        SetTabSelected(textPageBtn, currentPageIndex == 1);
        SetTabSelected(displayPageBtn, currentPageIndex == 2);
    ...
    private void SetTabSelected(Button button, bool selected)
    {
        ...
        if (background != null)
        {
            Color backgroundColor = selected ? selectedTabBackgroundColor : normalTabBackgroundColor;
        ...
        {
            iconImage.color = selected ? selectedTabTextColor : normalTabTextColor;
        }
